...
async def send_email(email: EmailStr, username: str, host: str) -> None:
    """
    Sends a letter to confirm the email.

    :param email: Email where the letter will be sent.
    :type email: EmailStr
    :param username: The username of the user.
    :type username: str
    :param host: The host to send a letter.
    :type host: str
...
async def send_email_reset_password(email: EmailStr, username: str, host: str) -> None:
    """
    Sends an email to confirm password reset.
